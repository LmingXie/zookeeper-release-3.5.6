...
public class QuorumPeerConfig {
    ...
    public boolean isDistributed() {
        boolean b = quorumVerifier != null;
        boolean standaloneEnabled = QuorumPeerConfig.standaloneEnabled;
        int size = quorumVerifier.getVotingMembers().size();

        return quorumVerifier!=null && (!QuorumPeerConfig.standaloneEnabled || quorumVerifier.getVotingMembers().size() > 1);
    }
