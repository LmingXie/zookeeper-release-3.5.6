...
/**
 * 此请求处理器通常在RequestProcessor 更改的开始。 它设置与更改系统状态的请求关联的所有事务。
 * 它依靠ZooKeeperServer来更新未完成的请求，因此它可以考虑生成事务时要应用的队列中的事务。
 */
public class PrepRequestProcessor extends ZooKeeperCriticalThread implements
    ...
    /**
     * 此方法将在ProcessRequestThread内部调用，该方法是一个单例，因此将有单个线程调用此代码。
     *
     * @param type
     * @param zxid
     * @param request
    ...
    protected void pRequest(Request request) throws RequestProcessorException {
        ...
        // PrepRequestProcessor负责创建事务，
        // 根据责任链进行调用，从ZooKeeperServer.setupRequestProcessors得知，PrepRequestProcessor 的下一个处理者是 SyncRequestProcessor
    ...
    /**
     * 此方法检查acl，以确保其不为null或为空，具有有效的方案和ID，并扩展依赖于请求者的身份验证信息的任何相对ID。
     *
