    ...
    public void run() {
        try {
            ...
            if (this.getVersion() < 0x10000) {
                ...
                // TODO 发送一个Epoch的ack确认，处于这个Epoch
            ...
            // 如果只是正在建立领导者，则此quorumVerifier的版本将由leader.lead（）设置。
            // 如果我们到了这里，waitForEpochAck确保readyToStart为true，所以设置了版本
            ...
            /*
             * 必须等待第一个ACK，直到领导者准备好，然后我们才能开始处理消息。
             */
            qp = new QuorumPacket();
            ia.readRecord(qp, "packet");
            ...
            // 突变数据包将在序列化过程中排队，因此，我们需要标记对等方何时可以实际开始使用数据
            //
