...
public class LeaderZooKeeperServer extends QuorumZooKeeperServer {
    ...
    protected void setupRequestProcessors() {
        ...
        // 内部实际是SyncRequestProcessor和AckRequestProcessor组成，SyncRequestProcessor 通过序列化技术持久化事务
        // SyncRequestProcessor 持久化事务(事务的顺序通过zxid保证)
        // AckRequestProcessor 发送Leader进行确认
        // CommitProcessor 提交事务
